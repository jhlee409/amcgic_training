...
with st.expander(" 필독!!! 먼저 여기를 눌러 사용방법을 확인하세요."):
    ...
    st.write("- 왼쪽에서 시청하고자 하는 강의를 선택하면 강의가 시작됩니다.")
...
# 사이드바에서 강의 선택
selected_lecture = st.sidebar.selectbox("Default누른 후 강의를 선택하세요", lectures, key='lecture_selector')

# 선택이 바뀌었는지 확인하기 위해 previous_lecture 사용
if 'previous_lecture' not in st.session_state:
    st.session_state['previous_lecture'] = None

# 만약 강의가 바뀌었다면, main_video_url 초기화
