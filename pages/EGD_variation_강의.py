...
if st.session_state.get('logged_in'):
    ...
    data = [
        ...
        '- 진정 내시경 시 환자가 너무 irritable서 검사의 진행이 어려워요',
    ...
    # Firebase Storage에 비디오 URL 로그를 저장하는 함수
    def save_video_url_log(video_url):
        try:
            ...
            User: {user_email}
            Video: {video_name}
            Access Time: {current_time}
            URL: {video_url}
            """
            
            # Firebase Storage에 로그 저장
            bucket = storage.bucket('amcgi-bulletin.appspot.com')
            log_blob = bucket.blob(f'logs/video_access/{user_email}_{video_name}_{current_time}.txt')
    ...
    markdown_texts = [
        f'<a href="{video_url_a1}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_a1}\'); return false;">Link 1</a>',
        '-',
        '-',
        '-',
        '-',
        '-',
        f'<a href="{video_url_b1}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_b1}\'); return false;">Link 1</a>, <a href="{video_url_b2}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_b2}\'); return false;">Link 2</a>',
        f'<a href="{video_url_c1}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_c1}\'); return false;">Link 1</a>, <a href="{video_url_c2}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_c2}\'); return false;">Link 2</a>',
        f'<a href="{video_url_d1}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_d1}\'); return false;">Link 1</a>, <a href="{video_url_d2}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_d2}\'); return false;">Link 1</a>',
        f'<a href="{video_url_e1}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_e1}\'); return false;">Link 1</a>, <a href="{video_url_e2}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_e2}\'); return false;">Link 2</a>, <a href="{video_url_e3}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_e3}\'); return false;">Link 3</a>, <a href="{video_url_e4}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_e4}\'); return false;">Link 4</a>',
        f'<a href="{video_url_f1}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_f1}\'); return false;">Link 1</a>, <a href="{video_url_f2}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_f2}\'); return false;">Link 2</a>, <a href="{video_url_f3}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_f3}\'); return false;">Link 3</a>',
        f'<a href="{video_url_g1}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_g1}\'); return false;">Link 1</a>',
        f'<a href="{video_url_h1}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_h1}\'); return false;">Link 1</a>, <a href="{video_url_h2}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_h2}\'); return false;">Link 2</a>',
        f'<a href="{video_url_i1}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_i1}\'); return false;">Link 1</a>, <a href="{video_url_i2}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_i2}\'); return false;">Link 2</a>',
        f'<a href="{video_url_j1}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_j1}\'); return false;">Link 1</a>, <a href="{video_url_j2}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_j2}\'); return false;">Link 2</a>, <a href="{video_url_j3}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_j3}\'); return false;">Link 3</a>, <a href="{video_url_j4}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_j4}\'); return false;">Link 4</a>, <a href="{video_url_j5}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_j5}\'); return false;">Link 5</a>',
        f'<a href="{video_url_k1}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_k1}\'); return false;">Link 1</a>',
        f'<a href="{video_url_l1}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_l1}\'); return false;">Link 1</a>',
        f'<a href="{video_url_m1}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_m1}\'); return false;">Link 1</a>',
        f'<a href="{video_url_n1}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_n1}\'); return false;">Link 1</a>, <a href="{video_url_n2}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_n2}\'); return false;">Link 2</a>, <a href="{video_url_n3}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_n3}\'); return false;">Link 3</a>',
        f'<a href="{video_url_o1}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_o1}\'); return false;">Link 1</a>, <a href="{video_url_o2}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_o2}\'); return false;">Link 2</a>, <a href="{video_url_o3}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_o3}\'); return false;">Link 3</a>',
        f'<a href="{video_url_p1}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_p1}\'); return false;">Link 1</a>, <a href="{video_url_p2}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_p2}\'); return false;">Link 2</a>',
        f'<a href="{video_url_q1}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_q1}\'); return false;">Link 1</a>, <a href="{video_url_q2}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_q2}\'); return false;">Link 2</a>, <a href="{video_url_q3}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_q3}\'); return false;">Link 3</a>',
        f'<a href="{video_url_r1}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_r1}\'); return false;">Link 1</a>, <a href="{video_url_r2}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_r2}\'); return false;">Link 2</a>, <a href="{video_url_r3}" onclick="window.open(this.href); fetch(\'/?log_url={video_url_r3}\'); return false;">Link 3</a>',
    ]
...
# Streamlit 앱에 엔드포인트 추가
if 'logged_in' in st.session_state and st.session_state.logged_in:
    # URL 파라미터 처리
    query_params = st.experimental_get_query_params()
    if 'log_url' in query_params:
        video_url = query_params['log_url'][0]
        save_video_url_log(video_url)