...
if st.session_state.get('logged_in'):
    ...
    with st.expander(" 필독!!! 먼저 여기를 눌러 사용방법을 확인하세요."):
        ...
        st.write("- 각 단계마다 반드시 '열일 중' 스핀이 멈출 때까지 기다리세요. 스핀 돌고있는 도중 다른 버튼 누르면 오류납니다.")
        st.write("- Impression을 적는 질문에 대한 대답은 실제 report에 적는 impression처럼 적으셔야 합니다. 의뢰자가 impression만 보는 경우가 많으므로, 추정 진단뿐 아니라 의미있는 항목은 모두 적어야합니다.")
        st.write("----- organ, 부위, 위치, 크기, 형태 분류는, 알 수 있으면 반드시 써야 합니다. 진료에 도움이 되는 의미있는 정보이기 때문입니다. 예; gastric MB PW, 1.8 cm, IIa type, TA")
