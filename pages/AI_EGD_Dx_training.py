...
if st.session_state.get('logged_in'):
    ...
    with st.expander(" 필독!!! 먼저 여기를 눌러 사용방법을 확인하세요."):
        ...
        st.write("- '질문을 시작해도 될까요?'라고 나오면 '예' 혹은 'yes'라고 대답하고 기다립니다.")
        st.write("- 잠시 후에 문제에 따라 질문이나 질문 없는 설명이 나옵니다. 질문인 경우는 대답을 하고 기다리면, 질문에 대한 평가가 나오고, 다음 질문이나 설명이 나오는 식으로 진행됩니다.")
