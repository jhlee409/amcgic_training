...
if st.session_state.get('logged_in'):
    ...
    with st.expander(" 반드시 순서대로 해야 정상 작동합니다. 먼저 여기를 눌러 사용방법을 확인하세요."):
        ...
        st.write("-    예를 들면 '그래요' 이렇게만 적으면 대답이 '..'입니다. 맥락의 정보를 충분히 담기 위해 '예, 조직생검은 필요합니다.' 이렇게 적어야 잘 알아 듣습니다.")
